defmodule ExchemaCoercion.Coercions.Numeric do
  ...
  # Examples
      ...
      :error
  """
  @spec from_string(any, Exchema.Type.t, [ExchemaCoercion.coercion], :strict | :normal) :: ExchemaCoercion.result
  ...
  """
  @spec integer_as_float(any, Exchema.Type.t, [ExchemaCoercion.coercion]) :: ExchemaCoercion.result
